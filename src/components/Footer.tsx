    ...
    >
      <motion.div initial={{ y: 0 }} style={{ y }}>
        ...
        <section className='flex flex-col items-start justify-start gap-4 xl:items-end xl:justify-between xl:flex-row'>
          <Button
            className='overflow-hidden text-6xl leading-none transition-colors duration-1000 ease-in-out-monospace xl:-mb-6 text-monospace-white xl:text-10xl xl:hover:text-monospace-light-gray'
          ...
          <ul className='flex items-end gap-6 leading-none xl:gap-4 xl:flex-col'>
            {SOCIAL_LINKS.map((social) => (
              <li key={social.name}>
                <motion.a
                  className='block overflow-hidden text-xl transition-colors duration-1000 ease-in-out-monospace xl:text-base text-monospace-light-gray xl:hover:text-monospace-white'
                  href={social.link}
            ...
            <li>
              <Button
                className='overflow-hidden text-xl transition-colors duration-1000 ease-in-out-monospace xl:text-base group text-monospace-light-gray xl:hover:text-monospace-white'
