...
export default function ScrollPercentage() {
  ...
  return (
    <div
      className={clsx(
        'fixed bottom-8 right-8 tracking-wide flex justify-center min-w-[58px] px-3 pt-[10px] pb-2 transition-transform ease-in-out duration-1000 leading-none z-10 rounded-full bg-kili-white/60 text-kili-black backdrop-blur-sm',
