...
export default function ScrollPercentage() {
  ...
  return (
    <div
      className={clsx(
        'fixed bottom-6 right-6 xl:bottom-8 xl:right-8 tracking-wide flex text-sm xl:text-base justify-center min-w-[48px] xl:min-w-[58px] pt-2 pb-[6px] px-2 xl:px-3 xl:pt-[10px] xl:pb-2 transition-transform ease-in-out duration-1000 xl:leading-none leading-none z-10 rounded-full bg-kili-white/60 text-kili-black backdrop-blur-sm',
