  ...
  return (
    <section className='flex flex-wrap gap-20 px-40 pb-36'>
      {projects.map((project) => (
        ...
        >
          <Link
            className='relative flex items-center justify-center h-48 leading-none transition-colors duration-700 ease-in-out border-8 rounded-full px-14 text-8xl text-kili-white border-kili-light-gray xl:hover:border-kili-white group'
