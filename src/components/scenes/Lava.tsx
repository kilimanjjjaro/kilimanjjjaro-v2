...
void main() {
  ...
  float noise = snoise(vec3(noiseCoord.x * uTime * 7.0, noiseCoord.y, uTime * 10.0));
...
const UNIFORMS = {
  ...
  uColor: {
    value: [
      new THREE.Color('#ba3131'),
      new THREE.Color('#a9ba30'),
      new THREE.Color('#51ba30'),
      new THREE.Color('#30ba91'),
      new THREE.Color('#3058ba'),
      new THREE.Color('#ba30a2')
    ]
  }
}
...
export default function LavaBackground() {
  ...
  useFrame(() => {
    ...
    time.current += 0.00005

    const colors = [
      new THREE.Color(controls.color1),
      new THREE.Color(controls.color2),
      new THREE.Color(controls.color3),
      new THREE.Color(controls.color4),
      new THREE.Color(controls.color5),
      new THREE.Color(controls.color6)
    ]

    shaderMaterialRef.current.uniforms.uTime.value = time.current
    shaderMaterialRef.current.uniforms.uColor.value = colors
  })
