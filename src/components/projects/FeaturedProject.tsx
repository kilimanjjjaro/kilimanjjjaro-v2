  ...
  return (
    ...
    >
      <article className='relative flex flex-col aspect-[18/25] group cursor-none'>
        <motion.header
          className='top-0 left-0 p-5 flex items-center xl:absolute w-full h-full bg-[length:135%] xl:group-hover:bg-[length:114%] transition-[background-size] ease-in-out-monospace duration-1000'
          style={{
        ...
        >
          <motion.div
            className='w-full relative transition-transform duration-1000 ease-in-out-monospace scale-100 xl:scale-[.85] aspect-video xl:group-hover:scale-100'
            initial={{
              opacity: 0
            }}
            animate={
          ...
          >
            ...
            <video
              ref={videoRef}
              className='transition-opacity duration-1000 ease-in-out-monospace xl:opacity-0 aspect-video xl:absolute xl:group-hover:opacity-100'
